...
export const meta = {
  ...
  Toc: () => (
    <TableLists>
      <TableListItem
        jumpTo="referencing-a-value-with-a-ref"
        title="Referencing a value with a ref"
      >
        <TableLists>
          <TableListItem jumpTo="click-counter" title="Click counter" />
          <TableListItem jumpTo="stopwatch" title="Stopwatch" />
        </TableLists>
      </TableListItem>
      <TableListItem
        jumpTo="manipulating-the-dom-with-a-ref"
        title="Manipulating the DOM with a ref"
      >
        <TableLists>
          <TableListItem
            jumpTo="focusing-a-text-input"
            title="Focusing a text input"
          />
          <TableListItem
            jumpTo="scrolling-an-image-into-view"
            title="Scrolling an image into view"
          />
          <TableListItem
            jumpTo="playing-and-pausing-a-video"
            title="Playing and pausing a video"
          />
          <TableListItem
            jumpTo="exposing-a-ref-to-your-own-component"
            title="Exposing a ref to your own component"
          />
        </TableLists>
      </TableListItem>
      <TableListItem
        jumpTo="avoiding-recreating-the-ref-contents"
