...
> #### Table of contents
>
> 1. [Referencing a value with a ref](#referencing-a-value-with-a-ref)
>    1. [Click counter](#click-counter)
>    2. [Stopwatch](#stopwatch)
> 2. [Manipulating the DOM with a ref](#manipulating-the-dom-with-a-ref)
>    1. [Focusing a text input](#focusing-a-text-input)
>    2. [Scrolling an image into view](#scrolling-an-image-into-view)
>    3. [Playing and pausing a video](#playing-and-pausing-a-video)
>    4. [Exposing a ref to your own component](#exposing-a-ref-to-your-own-component)
> 3. [Avoiding recreating the ref contents](#avoiding-recreating-the-ref-contents)
