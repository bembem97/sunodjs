...
export const meta = {
  ...
  Toc: () => (
    <ol>
      <li>
        <a href="#passing-data-deeply-into-the-tree">
          Passing data deeply into the tree
        </a>
        <ol>
          <li>
            <a href="#setting-theme-to-dark">Setting theme to dark</a>
          </li>
        </ol>
      </li>
      <li>
        <a href="#updating-data-passed-via-context">
        ...
        <ol>
          ...
          <li>
            <a href="#toggle-theme">Toggle theme</a>
          </li>
          <li>
            <a href="#multiple-context">Multiple context</a>
          </li>
          <li>
            <a href="#extracting-providers-to-a-component">
              Extracting providers to a component
            </a>
          </li>
          <li>
            <a href="#scaling-up-with-context-and-a-reducer">
      ...
      <li>
        <a href="#specifying-a-fallback-default-value">
          Specifying a fallback default value
        </a>
      </li>
      <li>
        <a href="#overriding-context-for-a-part-of-the-tree">
          Overriding context for a part of the tree
        </a>
      </li>
      <li>
        <a href="#optimizing-re-renders-when-passing-objects-and-functions">
