...
>    3. [Multiple context](#multiple-context)
>    4. [Extracting providers to a component](#extracting-providers-to-a-component)
>    5. [Scaling up with context and a reducer](#scaling-up-with-context-and-a-reducer)
